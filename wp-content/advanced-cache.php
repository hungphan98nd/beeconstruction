...
// WP-Optimize advanced-cache.php (written by version: 4.1.1) (homeurl: http://localhost/beeconstruction/) (abspath: C:\Program Files\Ampps\www\beeconstruction/) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'C:\Program Files\Ampps\www\beeconstruction\wp-content\plugins\wp-optimize\cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost/beeconstruction/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'C:\Program Files\Ampps\www\beeconstruction\wp-content\plugins\wp-optimize\cache/extensions');
}
